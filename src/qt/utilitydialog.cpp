    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Gupcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Gupcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  gupcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Gupcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GUP, 0.1 GUP, 1 GUP and 10 GUP -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://gupcoincoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://gupcoincoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Gupcoin Core is shutting down...") + "<br /><br />" +
