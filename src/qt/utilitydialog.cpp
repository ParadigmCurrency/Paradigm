    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Paradigm Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Paradigm Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  paradigm-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Paradigm in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PDM, 0.1 PDM, 1 PDM and 10 PDM -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://paradigmcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://paradigmcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Paradigm Core is shutting down...") + "<br /><br />" +
