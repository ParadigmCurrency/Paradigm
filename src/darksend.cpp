...
{
    if(fLiteMode) return; // ignore all Paradigm related functionality
...
/*
    ...
    allow endless transaction that would bloat Paradigm and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("paradigm-privatesend");
