...
{
    if(fLiteMode) return; // ignore all Gupcoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Gupcoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("gupcoin-privatesend");
