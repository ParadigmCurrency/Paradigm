...
This mechanism has been integrated into Bitcore-Node-Paradigm which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/paradigmcoin/insight-api-paradigm#web-socket-api](https://github.com/paradigmcoin/insight-api-paradigm#web-socket-api) 
* API: [https://github.com/paradigmcoin/insight-api-paradigm#instantsend-transactions](https://github.com/paradigmcoin/insight-api-paradigm#instantsend-transactions) 
...
By default, the Paradigm Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Paradigm Core daemon:
