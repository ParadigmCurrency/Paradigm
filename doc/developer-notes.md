...
Paradigm Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Paradigm Core, where everyone uses
...
pay attention to for reviewers of Paradigm Core code.

General Paradigm Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Paradigm Core uses tinyformat, which is type safe. Leave them out to avoid confusion
