...
Gupcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Gupcoin Core, where everyone uses
...
pay attention to for reviewers of Gupcoin Core code.

General Gupcoin Core
----------------------
...
- Use the RAII (Resource Acquisition Is Initialization) gupcoin where possible. For example by using
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Gupcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
