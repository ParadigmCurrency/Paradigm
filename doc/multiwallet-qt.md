...
Only requiring some minor changes is paradigm.cpp.
...
Changes to paradigm.cpp
----------------------
paradigm.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
